...
class HighlightsWidget extends Widget {
	...
	protected function render() {
		...
		$this->add_inline_editing_attributes( 'highlights', 'advanced' );
		$this->add_render_attribute(
			'highlights',
			array(
				'id'    => 'wte-highlights',
				'class' => array( 'highlights-content' ),
			)
		);
		echo '<div ' . $this->get_render_attribute_string( 'highlights' ) . '>' . $this->get_settings( 'highlights' ) . '</div>';
	}
}
