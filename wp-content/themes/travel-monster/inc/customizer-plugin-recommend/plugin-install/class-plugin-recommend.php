...
if( ! class_exists( 'Travel_Monster_Plugin_Install_Helper' ) ){
	return;
}
 ...
 */
class Travel_Monster_Plugin_Recommend_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		Travel_Monster_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	public function create_plugin_install_button($slug) {
		return Travel_Monster_Plugin_Install_Helper::instance()->get_button_html($slug);
	}
}
