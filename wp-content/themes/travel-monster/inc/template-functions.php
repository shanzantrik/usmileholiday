					...
					<div class="footer-cop">
						<?php
							...
							if( travel_monster_pro_is_activated() ){
								...
								__( ' U Smile Holiday ', 'travel-monster' ) .'
								<a href="' . esc_url( 'https://wptravelengine.com/' ) .'" rel="nofollow" target="_blank">' . esc_html__( 'All rights reserved', 'travel-monster' ) . '.</a></span>';
								printf( esc_html__( '%1$s Powered by %2$s%3$s', 'Shantanu' ), '<span class="wp-link">', '<a href="'. esc_url( '#', 'travel-monster' ) .'" rel="nofollow" target="_blank">Multitudinous Web</a>.', '</span>' );
							}
						?>
					</div>
